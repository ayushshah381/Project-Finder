  ...
  render() {
    return (
      <React.Fragment>
        <Card className="card">
          <CardContent>
            <p style={{ fontSize: "18px", fontWeight: "initial" }}>{this.state.teamName}</p>
            <p style={{ color: "#12b6a6", fontWeight: "600", fontSize: "24px" }}>{this.state.hackathonName}</p>
            <p style={{ color: "#484349", fontSize: "16px" }}>
              {this.state.members}
            </p>
            <br />
            <p>Description</p>
            <p style={{ opacity: "80%", fontSize:"16px" }}>{this.state.tdesc}</p>
            <br />
            <p>Skills Required</p>
